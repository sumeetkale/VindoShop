                ...
                <div class="row">
                            ...
                            <ul class="nav nav-pills flexnav" id="flexnav" data-breakpoint="800">
                                ...
                                <li class="active"><a href="page-full-width.html">Pages</a>
                                    <ul>
                                        ...
                                        <li class="active"><a href="page-404.html">404</a>
                                        </li>
                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="login-register">
                            <li class="heart"><a href="page-cart.html"><i class="fa fa-heart"></i>My Cart</a>
                                <div class="heart-box">
                                    <ul class="heart-items">
                                        <li>
                                            <a href="product-shop-sidebar.html">
                                                <img src="img/70x70.png" alt="Image Alternative text" title="AMaze" />
                                                <h5>New Glass Collection</h5><span class="heart-item-price">$150</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="product-shop-sidebar.html">
                                                <img src="img/70x70.png" alt="Image Alternative text" title="Gamer Chick" />
                                                <h5>Playstation Accessories</h5><span class="heart-item-price">$170</span>
                                            </a>
                                        </li>
                                    </ul>
                                    <ul class="list-inline text-center">
                                        <li><a href="page-cart.html"><i class="fa fa-heart"></i> View Cart</a>
                                        </li>
                ...
                <div class="container">
                    <div class="row row-wrap">
                        <div class="col-md-3">
                            ...
                            <p>Libero proin aliquet sagittis aptent pellentesque phasellus hendrerit dignissim conubia potenti curabitur venenatis hac volutpat convallis velit auctor suscipit quisque</p>
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="box">
                                <form>
                                    ...
                                    <p class="mb10">Curabitur auctor ullamcorper sapien orci libero venenatis</p>
                            ...
                            <ul class="thumb-list">
                                <li>
                                    ...
                                    <div class="thumb-list-item-caption">
                                        ...
                                        <h5 class="thumb-list-item-title"><a href="#">Viverra mauris</a></h5>
                                        <p class="thumb-list-item-desciption">Aptent morbi consequat nam phasellus</p>
                                    </div>
                                </li>
                                <li>
                                    <a href="#">
                                    ...
                                    <div class="thumb-list-item-caption">
                                        <p class="thumb-list-item-meta">Jul 18, 2014</p>
                                        <h5 class="thumb-list-item-title"><a href="#">Nunc sit</a></h5>
                                        <p class="thumb-list-item-desciption">Mus viverra netus platea duis</p>
                                    </div>
                                </li>
                                <li>
                                    <a href="#">
                                    ...
                                    <div class="thumb-list-item-caption">
                                        <p class="thumb-list-item-meta">Jul 18, 2014</p>
                                        <h5 class="thumb-list-item-title"><a href="#">Faucibus tincidunt</a></h5>
                                        <p class="thumb-list-item-desciption">Sem rhoncus malesuada magnis rutrum</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
