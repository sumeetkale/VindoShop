...
$("#addOfferBtn").click(function () {
    $("#addOffer").css("display", "block");
});
$("#addOutletBtn").click(function () {
    $("#addOutlet").css("display", "block");
});
$(".modalClose").click(function () {
    $("#addOffer").css("display", "none");
    $("#outletImages").css("display", "none");
    $("#addOutlet").css("display", "none");
});
$(".editOfferBtn").click(function () {
    $("#addOffer").css("display", "block");
});
$(".outletImages").click(function () {
    $("#outletImages").css("display", "block");
});